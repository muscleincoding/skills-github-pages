...
class SearchServer:
    def __init__(self):
        ...
        for filename in os.listdir(DIRECTORY):
            if filename.endswith('.txt'):  # add any file extension you want
                filename = 'C://Users//YSJ//Downloads//Assignment6//bbcnews//' + filename
                file_list.append(filename)
        self.index = create_index(file_list,{},{})
    ...
    def handle_request(self, request):
        ...
        if request.command == 'search':
            ...
            results = search(self.index, query)[:MAX_RESPONSES_PER_REQUEST]
            response = [{'title': result} for result in results]
